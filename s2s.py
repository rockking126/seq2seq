...
def str2id(s, start_end=True):
    # 文字转整数id
    idd = []
    s = str(s) + ' '
    if start_end:  # 补上<start>和<end>标记
        ids = [char2id.get(str(c), 1) for c in str(s[:max_len - 2])]
        ids = [2] + ids + [3]
    else:  # 普通转化
        for c in s:
            for d in c[:max_len]:
                idd.append(char2id.get(d, 1))
...
#                 # bb = padding(X)
#                 # cc = padding(Y)
#                 X = np.array(str2id(X, start_end=True))
#                 Y = np.array(str2id(Y, start_end=True))
#                 yield [X,Y], None
#                 # print(Y)
#                 X,Y = [],[]
...
def data_generator():
    ...
    while True:
        for index, a in data.iterrows():
            X.append(str2id(a['content_list']))
            Y.append(str2id(a['tittle']))
            if len(X) == batch_size:
...
s1 = u'သႀကၤန္ကာလအတြင္း ယာဥ္မေတာ္တဆမႈ၊ မူခင္းႀကိဳတင္ကာကြယ္ေရးနဲ႔ လုံၿခဳံေရး အတြက္ တိုင္းရင္းသား လက္နက္ကိုင္အဖဲြ႔အစည္းေတြနဲ႔ပူးေပါင္းၿပီး ေရွာင္တခင္စစ္ေဆး ေဆာင္ရြက္သြားမယ္လို႔ ဘားအံၿမိဳ႕၊ အမွတ္ ၇၀ ယာဥ္ထိန္းတပ္ဖဲြ႔စုု၊ ေခတၱတပ္ဖဲြ႔မႉး ရဲအုပ္ ၀င္းသန္းက ေျပာပါတယ္။သႀကၤန္မွာ ယာဥ္အႏၱရာယ္ေလ်ာ့နည္းေစဖုိ႔၊ လမ္းစည္းကမ္းလိုက္နာ ဖို႔၊ပါ၀ါအိတ္ေဇာ တပ္ေမာင္းႏွင္တာေတြ၊ ေပါက္ကဲြေစတတ္တဲ့ လက္နက္ခဲယမ္းနဲ႔ မူးယစ္ဆး၀ါး သယ္ေဆာင္ လာတာေတြမရွိေစဖို႔အတြက္ ရည္ရြယ္ၿပီး ေဆာင္ရြက္တာလို႔ ဆိုပါတယ္။，ရဲအုပ္၀င္းသန္းက တိုင္းရင္းသား လက္နက္ကိုင္အဖဲြ႔အစည္းေတြကေတာ့ သူတို႔ရဲ႕ မိသားစုတပ္ဖဲြ႔၀င္ေတြ စီးႏွင္းေနတဲဲ့ယာဥ္ေတြက်ေတာ့ က်ေနာ္တို႔က အလုံးစုံမသိႏိုင္ဘူး။ မသိႏိုင္တဲ့အခါက်ေတာ့ က်ေနာ္တို႔ကို၀ိုင္း၀န္းကူညီၿပီး ေဆာင္ရြက္ေပးတာျဖစ္ပါတယ္လို႔ ေျပာပါတယ္။ေကအန္ယူ၊ ေကအန္အန္လ္ေအၿငိမ္းခ်မ္းေရးေကာင္စီ ဆက္ဆံေရး႐ုံးတာ၀န္ခံ ဗုိလ္မႉး ေစာေအာင္ခ်စ္က ၿငိမ္းခ်မ္းေရးအဖဲြ႔က ကိုယ္ဟာကိုယ္ထိန္းမယ္ဆိုရင္ေတာ့ အဆင္ေျပမယ္လို႔ ထင္တယ္။ က်ေနာ္တို႔ဆီကေတာ့ တတ္ႏိုင္သေလာက္ ႀကိဳးစားၿပီးေတာ့ ၀ိုင္း၀န္းထိန္းေပးတာ။ မူးယစ္ေဆး၀ါးတို႔ က်န္တဲ့ကိစၥလည္း အမ်ားႀကီး ပါတဲ့အတြက္ေၾကာင့္လို႔ ေျပာပါတယ္။ဧၿပီ ၁ ရက္ကစၿပီး ယာဥ္မေတာ္တဆမႈ၊ မူခင္းႀကိဳတင္ကာကြယ္ေရးနဲ႔ လုံၿခဳံေရးအတြက္ တိုင္းရင္းသားလက္နက္ကိုင္အဖဲြ႔အစည္းေတြ၊ ဌာနဆိုင္ရာေတြ၊ တပ္မေတာ္၊ လူမႈေရးအသင္းအဖဲြ႔ေတြနဲ႔ ပူးေပါင္းၿပီး ဆိုင္ကယ္နဲ႔ ေမာ္ေတာ္ယာဥ္ေတြကို စစ္ေဆးေနပါတယ္။မြန္ျပည္နယ္၊ မုဒုံၿမိဳ႕၊ ဦးေမာင္ေမာင္ကသႀကၤန္အခါရက္အတြင္းမွာ ေသာက္စား မူးယစ္တာရွိရင္ေတာ့ အႏၱရာယ္ရွိမွာပဲ။ မေသာက္တာအေကာင္းဆုံးပဲ။ ယာဥ္ေမာင္းတဲ့ သူတိုင္းက ေသာက္ၿပီးလို႔ရွိရင္ အသိဉာဏ္ ကင္းလြတ္သြားတဲ့အတြက္ အႏၱရာယ္ျဖစ္တတ္ တယ္လို႔ ေျပာပါတယ္။၂၀၁၈ မဟာသႀကၤန္ကာလမွာ ကရင္ျပည္နယ္အတြင္း ယာဥ္မေတာ္တဆမႈ ၁၀ မႈျဖစ္ပြားခဲ့ၿပီး၊ ဒဏ္ရာ ရရွိသူ က်ား ၁၆ ဦး၊ မ ၈ ဦး၊ ေသဆုံးသူ က်ား ၁၀ ဦးနဲ႔ ပ်က္စီးဆုံးရႈံးမႈ တန္ဖိုး က်ပ္ ၆၃ သိန္းခန္႔ရွိခဲ့တယ္လို႔ ယာဥ္ထိန္း ရဲတပ္ဖဲြ႔က သိရပါတယ္။သတင္း- ရဲမင္းေခါင္'
